...
<style>
  ...
  .animated-grid-panel {
    ...
    --animated-grid-glow: color-mix(in oklab, var(--animated-grid-accent) 36%, transparent);
    --animated-grid-line: color-mix(in oklab, var(--animated-grid-accent) 40%, transparent);
